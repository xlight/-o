<?php
class Basketball_Model_Match extends OK_ActiveRecord_Abstract
{
	/**
	 * 返回对象的定义
	 *
	...
	static function __define()
	{
		return array (
				...
				'props' => array (
					...
					'participate' => array(OK_DB::HAS_MANY => 'Basketball_Model_Participate','source_key' => 'id','target_key' => 'match_id'),
					),
