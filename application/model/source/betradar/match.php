<?php
class Model_Source_Betradar_Match extends OK_ActiveRecord_Abstract
{
	/**
	 * 返回对象的定义
	 *
	...
	static function __define()
	{
		return array (
				...
				'props' => array (
					...
					'participate' => array(OK_DB::HAS_MANY => 'Model_Source_Betradar_Participate','source_key' => 'id','target_key' => 'match_id'),
					),
