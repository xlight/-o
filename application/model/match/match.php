<?php
class Model_Match_Match extends OK_ActiveRecord_Abstract
{
	/**
	 * 返回对象的定义
	 *
	...
	static function __define()
	{
		return array (
				// 用什么数据表保存对象
				'table_name' => 'match',          
				'table_config' => array('dsn'	=> 'matchs'),

				// 指定数据表记录字段与对象属性之间的映射关系
				// 没有在此处指定的属性，QeePHP 会自动设置将属性映射为对象的可读写属性
				'props' => array (
					// 主键应该是只读，确保领域对象的“不变量”
					'match_id' => array('readonly' => true),
					'participate' => array(OK_DB::HAS_MANY => 'Model_Match_Participate','source_key' => 'match_id','target_key' => 'match_id'),
					),
