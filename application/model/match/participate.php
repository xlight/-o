<?php
class Model_Match_Participate extends OK_ActiveRecord_Abstract
{
	/**
	 * 返回对象的定义
	 *
	...
	static function __define()
	{
		return array (
				...
				'props' => array (
					// 主键应该是只读，确保领域对象的“不变量”
					'participate_id' => array('readonly' => true),
					'team' => array(OK_DB::HAS_ONE => 'Model_Match_Team','source_key' => 'entity_id','target_key' => 'team_id'),
					),
